...
#Create a class-based "Programmer" table
...
steve_whitehouse = Programmer(
    first_name="Steve",
    last_name="Whitehouse",
    gender="M",
    nationality="British",
    famous_for="Massive Tea Consumption"
)"""
# add instances of programmers
...
#programmer.famous_for = "Massive Tea Comsumption"
#session.commit()
